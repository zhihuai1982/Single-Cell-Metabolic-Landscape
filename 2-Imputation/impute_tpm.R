...
scimpute(file.path(outDir, "tumor.tpm"),
    infile = "csv", outfile = "csv", out_dir = file.path(outDir, "malignant_"),
...
# non tumor
scimpute(file.path(outDir, "nontumor.tpm"),
    infile = "csv", outfile = "csv", out_dir = file.path(outDir, "non-malignant_"),
