...
pheatmap(dist_dat, show_rownames = F, show_colnames = F, cluster_rows = hc, cluster_cols = hc, annotation_col = col_row, annotation_row = col_row, color = mycolor, annotation_legend = T)
dev.off()
