...
TCGA_exp_file <- file.path("./TCGA", tumor, "exp.txt")
TCGA_type_file <- file.path("./TCGA", tumor, "type.txt")
...
row_data <- data.frame(
    geneid = str_split_fixed(rownames(exp_data), fixed("."), 2)[, 1],
